/*! starklines v0.0.1 09-04-2014 */
function dismissAlert(elem) {
    elem.innerHTML = "", document.getElementById("messages").style.display = "none";
}
...
d3 = function() {
    ...
    function A(n) {
        return arguments.length || (n = $o.ascending), function(t, e) {
    ...
    function D() {
        var n = ".dragsuppress-" + ++wa, t = "click" + n, e = $o.select(Ko).on("touchmove" + n, f).on("dragstart" + n, f).on("selectstart" + n, f);
        if (ba) {
            var r = Go.style, u = r[ba];
            r[ba] = "none";
        }
        return function(i) {
            function o() {
    ...
    function P(n, t) {
        ...
        if (e.createSVGPoint) {
            ...
            return Sa ? (r.x = t.pageX, r.y = t.pageY) : (r.x = t.clientX, r.y = t.clientY), 
    ...
    function st(n, t, e) {
        ...
        return (i = Xa.get(n)) ? t(i.r, i.g, i.b) : (null != n && "#" === n.charAt(0) && (4 === n.length ? (o = n.charAt(1), 
        o += o, a = n.charAt(2), a += a, c = n.charAt(3), c += c) : 7 === n.length && (o = n.substring(1, 3), 
        a = n.substring(3, 5), c = n.substring(5, 7)), o = parseInt(o, 16), a = parseInt(a, 16), 
        c = parseInt(c, 16)), t(o, a, c));
    }
    function lt(n, t, e) {
        ...
        r *= 60) : (r = 0/0, u = c > 0 && 1 > c ? 0 : r), V(r, u, c);
    }
    function ft(n, t, e) {
        n = ht(n), t = ht(t), e = ht(e);
        var r = et((.4124564 * n + .3575761 * t + .1804375 * e) / Oa), u = et((.2126729 * n + .7151522 * t + .072175 * e) / Ya), i = et((.0193339 * n + .119192 * t + .9503041 * e) / Ia);
    ...
    function mt(n, t, e, r) {
        ...
        var i = {}, o = $o.dispatch("beforesend", "progress", "load", "error"), a = {}, c = new XMLHttpRequest(), s = null;
        return !Ko.XDomainRequest || "withCredentials" in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest()), 
    ...
    function xt() {
        var n = Mt(), t = _t() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(Ja), Ja = setTimeout(xt, t)), Wa = 0) : (Wa = 1, 
        Ka(xt));
    }
    function Mt() {
        var n = Date.now();
    ...
    function _t() {
        for (var n, t = $a, e = 1 / 0; t; ) t.f ? t = n ? n.n = t.n : $a = t.n : (t.t < e && (e = t.t), 
        t = (n = t).n);
        return Ba = n, e;
    }
    function bt(n, t) {
    ...
    function Ot() {
        function n(n, u) {
            n *= La;
            var i = Math.cos(u *= La), o = i * Math.cos(n), a = i * Math.sin(n), c = Math.sin(u), s = Math.atan2(Math.sqrt((s = e * c - r * a) * s + (s = r * o - t * c) * s + (s = t * a - e * o) * s), t * o + e * a + r * c);
            vc += s, xc += s * (t + (t = o)), Mc += s * (e + (e = a)), _c += s * (r + (r = c)), 
            Ft(t, e, r);
        }
        var t, e, r;
    ...
    function It() {
        function n(n, t) {
            n *= La;
            var e = Math.cos(t *= La), o = e * Math.cos(n), a = e * Math.sin(n), c = Math.sin(t), s = u * c - i * a, l = i * o - r * c, f = r * a - u * o, h = Math.sqrt(s * s + l * l + f * f), g = r * o + u * a + i * c, p = h && -j(g) / h, v = Math.atan2(h, g);
            bc += p * s, wc += p * l, Sc += p * f, vc += v, xc += v * (r + (r = o)), Mc += v * (u + (u = a)), 
            _c += v * (i + (i = c)), Ft(r, u, i);
        }
        var t, e, r, u, i;
    ...
    function Vt(n, t, e, r, u) {
        ...
        if (n.forEach(function(n) {
            if (!((t = n.length - 1) <= 0)) {
                ...
                c.o = s, i.push(c), o.push(s), c = new $t(r, n, null, !1), s = new $t(r, null, c, !0), 
        ...
        return function(u, i) {
            ...
            var g, p, v, d = t(i), m = u.invert(r[0], r[1]), y = {
                ...
                polygonEnd: function() {
                    ...
                    var n = Kt(m, p);
                    g.length ? Vt(g, Gt, n, e, i) : n && (i.lineStart(), e(null, null, 1, i), i.lineEnd()), 
                    i.polygonEnd(), g = p = null;
                },
                sphere: function() {
    ...
    function Kt(n, t) {
        ...
        for (var a = 0, c = t.length; c > a; ++a) {
            ...
            if (l) for (var f = s[0], h = f[0], g = f[1] / 2 + ka / 4, p = Math.sin(g), v = Math.cos(g), d = 1; ;) {
                d === l && (d = 0), n = s[d];
                var m = n[0], y = n[1] / 2 + ka / 4, x = Math.sin(y), M = Math.cos(y), _ = m - h, b = aa(_) > ka, w = p * x;
                if (hc.add(Math.atan2(w * Math.sin(_), v * M + w * Math.cos(_))), i += b ? _ + (_ >= 0 ? Ea : -Ea) : _, 
                b ^ h >= e ^ m >= e) {
                    var S = zt(Tt(f), Tt(n));
                    Pt(S);
                    var k = zt(u, S);
    ...
    function Qt(n) {
        ...
        return {
            ...
            point: function(i, o) {
                var a = i > 0 ? ka : -ka, c = aa(i - e);
                aa(c - ka) < Ca ? (n.point(e, r = (r + o) / 2 > 0 ? Aa : -Aa), n.point(u, r), n.lineEnd(), 
                n.lineStart(), n.point(a, r), n.point(i, r), t = 0) : u !== a && c >= ka && (aa(e - u) < Ca && (e -= u * Ca), 
                aa(i - a) < Ca && (i -= a * Ca), r = ne(e, r, i, o), n.point(u, r), n.lineEnd(), 
    ...
    function te(n, t, e, r) {
        var u;
        if (null == n) u = e * Aa, r.point(-ka, u), r.point(0, u), r.point(ka, u), r.point(ka, 0), 
        r.point(ka, -u), r.point(0, -u), r.point(-ka, -u), r.point(-ka, 0), r.point(-ka, u); else if (aa(n[0] - t[0]) > Ca) {
            var i = n[0] < t[0] ? ka : -ka;
    ...
    function ee(n) {
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    var g, p = [ f, h ], v = t(f, h), d = o ? v ? 0 : u(f, h) : v ? u(f + (0 > f ? ka : -ka), h) : 0;
                    if (!e && (s = c = v) && n.lineStart(), v !== c && (g = r(e, p), (jt(e, g) || jt(p, g)) && (p[0] += Ca, 
                    p[1] += Ca, v = t(p[0], p[1]))), v !== c) l = 0, v ? (n.lineStart(), g = r(p, e), 
        ...
        function r(n, t, e) {
            var r = Tt(n), u = Tt(t), o = [ 1, 0, 0 ], a = zt(r, u), c = qt(a, a), s = a[0], l = c - s * s;
            if (!l) return !e && n;
            ...
            if (!(0 > x)) {
                ...
                w > S && (b = w, w = S, S = b);
                var A = S - w, C = aa(A - ka) < Ca, N = C || Ca > A;
        ...
        var i = Math.cos(n), o = i > 0, a = aa(i) > Ca, c = Le(n, 6 * La);
    ...
    function ue(n, t, e, r) {
        ...
        return function(a) {
            function c(n) {
                for (var t = 0, e = m.length, r = n[1], u = 0; e > u; ++u) for (var i, o = 1, a = m[u], c = a.length, l = a[0]; c > o; ++o) i = a[o], 
            ...
            function v(n, t) {
                ...
                var e = f(n, t);
                if (m && y.push([ n, t ]), k) x = n, M = t, _ = e, k = !1, e && (a.lineStart(), 
                a.point(n, t)); else if (e && S) a.point(n, t); else {
                    var r = {
                        a: {
                            x: b,
                            y: w
                    ...
                    N(r) ? (S || (a.lineStart(), a.point(r.a.x, r.a.y)), a.point(r.b.x, r.b.y), e || a.lineEnd(), 
                    E = !1) : e && (a.lineStart(), a.point(n, t), E = !1);
                }
                b = n, w = t, S = e;
            }
            var d, m, y, x, M, _, b, w, S, k, E, A = a, C = Jt(), N = re(n, t, e, r), L = {
                ...
                polygonEnd: function() {
                    a = A, d = $o.merge(d);
                    var t = c([ n, r ]), e = E && t, u = d.length;
                    (e || u) && (a.polygonStart(), e && (a.lineStart(), l(null, null, 1, a), a.lineEnd()), 
                    u && Vt(d, i, t, l, a), a.polygonEnd()), d = m = y = null;
                }
            };
            return L;
        };
    ...
    function ve() {
        function n(n, t) {
            ...
            xc += o * (r + n) / 2, Mc += o * (u + t) / 2, _c += o, o = u * n - r * t, bc += o * (r + n), 
            wc += o * (u + t), Sc += 3 * o, he(r = n, u = t);
        }
        var t, e, r, u;
    ...
    function me(n) {
        ...
        function u(t, e, r, a, c, s, l, f, h, g, p, v, d, m) {
            ...
            if (M > 4 * i && d--) {
                var _ = a + g, b = c + p, w = s + v, S = Math.sqrt(_ * _ + b * b + w * w), k = Math.asin(w /= S), E = aa(aa(w) - 1) < Ca ? (r + h) / 2 : Math.atan2(b, _), A = n(E, k), C = A[0], N = A[1], L = C - t, T = N - e, q = x * L - y * T;
                (q * q / M > i || aa((y * L + x * T) / M - .5) > .3 || o > a * g + c * p + s * v) && (u(t, e, r, a, c, s, C, N, E, _ /= S, b /= S, w, d, m), 
    ...
    function be(n) {
        ...
        }), h = 150, g = 480, p = 250, v = 0, d = 0, m = 0, y = 0, x = 0, M = Ec, _ = vt, b = null, w = null;
        return t.stream = function(n) {
            return l && (l.valid = !1), l = we(M(o, f(_(n)))), l.valid = !0, l;
        }, t.clipAngle = function(n) {
            return arguments.length ? (M = null == n ? (b = n, Ec) : ee((b = +n) * La), u()) : b;
        }, t.clipExtent = function(n) {
            return arguments.length ? (w = n, _ = n ? ue(n[0][0], n[0][1], n[1][0], n[1][1]) : vt, 
            u()) : w;
        }, t.scale = function(n) {
            ...
            return arguments.length ? (m = n[0] % 360 * La, y = n[1] % 360 * La, x = n.length > 2 ? n[2] % 360 * La : 0, 
            r()) : [ m * Ta, y * Ta, x * Ta ];
        }, $o.rebind(t, f, "precision"), function() {
    ...
    function Le(n, t) {
        ...
        return function(u, i, o, a) {
            var c = o * t;
            null != u ? (u = Te(e, u), i = Te(e, i), (o > 0 ? i > u : u > i) && (u += o * Ea)) : (u = n + o * Ea, 
            i = n - .5 * c);
    ...
    function Ue() {
        function n(n, u) {
            var i = Math.sin(u *= La), o = Math.cos(u), a = aa((n *= La) - t), c = Math.cos(a);
            Uc += Math.atan2(Math.sqrt((a = o * Math.sin(a)) * a + (a = r * i - e * o * c) * a), e * i + r * o * c), 
            t = n, e = i, r = o;
        }
        var t, e, r;
    ...
    function Ye(n) {
        var t, e = _e(n), r = e.scale, u = e.translate, i = e.clipExtent;
    ...
    function Xe(n, t, e, r) {
        var u, i, o, a, c, s, l;
        return u = r[n], i = u[0], o = u[1], u = r[t], a = u[0], c = u[1], u = r[e], s = u[0], 
        l = u[1], (l - o) * (a - i) - (c - o) * (s - i) > 0;
    }
    function $e(n, t, e) {
    ...
    function Qe(n) {
        ...
        Ke(n);
        for (var c = i; c.circle && aa(e - c.circle.x) < Ca && aa(r - c.circle.cy) < Ca; ) i = c.P, 
        a.unshift(c), Ke(c), c = i;
        a.unshift(c), cr(c);
        for (var s = o; s.circle && aa(e - s.circle.x) < Ca && aa(r - s.circle.cy) < Ca; ) o = s.N, 
        a.push(s), Ke(s), s = o;
        a.push(s), cr(s);
        var l, f = a.length;
    ...
    function nr(n) {
        for (var t, e, r, u, i = n.x, o = n.y, a = $c._; a; ) if (r = tr(a, o) - i, r > Ca) a = a.L; else {
            if (u = i - er(a, o), !(u > Ca)) {
        ...
        var c = Ge(n);
        if ($c.insert(t, c), t || e) {
            if (t === e) return cr(t), e = Ge(t.site), $c.insert(c, e), c.edge = e.edge = hr(t.site, c.site), 
            ar(t), void ar(e);
            if (!e) return void (c.edge = hr(t.site, c.site));
            cr(t), cr(e);
            var s = t.site, l = s.x, f = s.y, h = n.x - l, g = n.y - f, p = e.site, v = p.x - l, d = p.y - f, m = 2 * (h * d - g * v), y = h * h + g * g, x = v * v + d * d, M = {
                x: (d * y - g * x) / m + l,
                y: (h * x - v * y) / m + f
            };
            pr(e.edge, s, p, M), c.edge = hr(s, n, null, M), e.edge = hr(n, p, null, M), ar(t), 
            ar(e);
        }
    }
    function tr(n, t) {
    ...
    function ur(n) {
        for (var t, e, r, u, i, o, a, c, s, l, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = Xc, d = v.length; d--; ) if (i = v[d], 
        i && i.prepare()) for (a = i.edges, c = a.length, o = 0; c > o; ) l = a[o].end(), 
        r = l.x, u = l.y, s = a[++o % c].start(), t = s.x, e = s.y, (aa(r - t) > Ca || aa(u - e) > Ca) && (a.splice(o, 0, new vr(gr(i.site, l, aa(r - f) < Ca && p - u > Ca ? {
            x: f,
            y: aa(t - f) < Ca ? e : p
        } : aa(u - p) < Ca && h - r > Ca ? {
            x: aa(e - p) < Ca ? t : h,
    ...
    function ar(n) {
        ...
        if (t && e) {
            ...
            if (r !== i) {
                ...
                if (!(h >= -Na)) {
                    var g = c * c + s * s, p = l * l + f * f, v = (f * g - s * p) / h, d = (c * p - l * g) / h, f = d + a, m = Gc.pop() || new or();
    ...
    function sr(n) {
        for (var t, e = Vc, r = re(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--; ) t = e[u], 
        (!lr(t, n) || !r(t) || aa(t.a.x - t.b.x) < Ca && aa(t.a.y - t.b.y) < Ca) && (t.a = t.b = null, 
        e.splice(u, 1));
    }
    function lr(n, t) {
        var e = n.b;
    ...
    function hr(n, t, e, r) {
        var u = new fr(n, t);
        return Vc.push(u), e && pr(u, n, t, e), r && pr(u, t, n, r), Xc[n.i].edges.push(new vr(u, n, t)), 
        Xc[t.i].edges.push(new vr(u, t, n)), u;
    }
    function gr(n, t, e) {
        var r = new fr(n, null);
    ...
    function _r(n, t) {
        ...
        for (Vc = [], Xc = new Array(n.length), $c = new dr(), Wc = new dr(); ;) if (u = Bc, 
        i && (!u || i.y < u.y || i.y === u.y && i.x < u.x)) (i.x !== e || i.y !== r) && (Xc[i.i] = new rr(i), 
        nr(i), e = i.x, r = i.y), i = n.pop(); else {
            if (!u) break;
            Qe(u.arc);
        }
        t && (sr(t), ur(t));
    ...
    function Ar(n, t, e, r, u, i) {
        if (!n(t, e, r, u, i)) {
            ...
            c[0] && Ar(n, c[0], e, r, o, a), c[1] && Ar(n, c[1], o, r, u, a), c[2] && Ar(n, c[2], e, a, o, i), 
            c[3] && Ar(n, c[3], o, a, u, i);
        }
    }
    function Cr(n, t) {
        n = $o.rgb(n), t = $o.rgb(t);
    ...
    function Tr(n, t) {
        ...
        for (n += "", t += "", Qc.lastIndex = 0, r = 0; e = Qc.exec(t); ++r) e.index && s.push(t.substring(a, c = e.index)), 
        l.push({
            i: s.length,
            x: e[0]
        }), s.push(null), a = Qc.lastIndex;
        for (a < t.length && s.push(t.substring(a)), r = 0, i = l.length; (e = Qc.exec(n)) && i > r; ++r) if (o = l[r], 
        o.x == e[0]) {
            if (o.i) if (null == s[o.i + 1]) for (s[o.i - 1] += o.x, s.splice(o.i, 1), u = r + 1; i > u; ++u) l[u].i--; else for (s[o.i - 1] += o.x + s[o.i + 1], 
            s.splice(o.i, 2), u = r + 1; i > u; ++u) l[u].i -= 2; else if (null == s[o.i + 1]) s[o.i] = o.x; else for (s[o.i] = o.x + s[o.i + 1], 
            s.splice(o.i + 1, 1), u = r + 1; i > u; ++u) l[u].i--;
            l.splice(r, 1), i--, r--;
        } else o.x = Lr(parseFloat(e[0]), parseFloat(o.x));
        for (;i > r; ) o = l.pop(), null == s[o.i + 1] ? s[o.i] = o.x : (s[o.i] = o.x + s[o.i + 1], 
        s.splice(o.i + 1, 1)), i--;
    ...
    function Zr(n, t) {
        var e;
        return arguments.length < 2 && (t = .45), arguments.length ? e = t / Ea * Math.asin(1 / n) : (n = 1, 
        e = t / 4), function(r) {
    ...
    function Gr(n) {
        var t = [ n.a, n.b ], e = [ n.c, n.d ], r = Qr(t), u = Kr(t, e), i = Qr(nu(e, t, -u)) || 0;
        t[0] * e[1] < e[0] * t[1] && (t[0] *= -1, t[1] *= -1, r *= -1, u *= -1), this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Ta, 
        this.translate = [ n.e, n.f ], this.scale = [ r, i ], this.skew = i ? Math.atan2(u, i) * Ta : 0;
    }
    function Kr(n, t) {
    ...
    function tu(n, t) {
        var e, r = [], u = [], i = $o.transform(n), o = $o.transform(t), a = i.translate, c = o.translate, s = i.rotate, l = o.rotate, f = i.skew, h = o.skew, g = i.scale, p = o.scale;
    ...
    function uu(n) {
        for (var t = n.source, e = n.target, r = ou(t, e), u = [ t ]; t !== r; ) t = t.parent, 
        u.push(t);
    ...
    function ou(n, t) {
        if (n === t) return n;
        for (var e = iu(n), r = iu(t), u = e.pop(), i = r.pop(), o = null; u === i; ) o = u, 
        u = e.pop(), i = r.pop();
        return o;
    }
    function au(n) {
    ...
    function fu(n, t, e) {
        ...
        null != i && (fu(i, t, e), n.charge += i.charge, r += i.charge * i.cx, u += i.charge * i.cy);
        if (n.point) {
    ...
    function hu(n, t) {
        return $o.rebind(n, t, "sort", "children", "value"), n.nodes = n, n.links = du, 
        n;
    }
    function gu(n) {
        return n.children;
    ...
    function Tu(n, t) {
        var e = n.children;
        if (e && (u = e.length)) for (var r, u, i = -1; ++i < u; ) t(r = Tu(e[i], t), n) > 0 && (n = r);
        return n;
    }
    function qu(n, t) {
        return n.x - t.x;
    ...
    function Du(n, t) {
        function e(n, r) {
            var u = n.children;
            if (u && (o = u.length)) for (var i, o, a = null, c = -1; ++c < o; ) i = u[c], e(i, a), 
            a = i;
            t(n, r);
        }
        e(n, null);
    ...
    function Pu(n) {
        for (var t, e = 0, r = 0, u = n.children, i = u.length; --i >= 0; ) t = u[i]._tree, 
        t.prelim += e, t.mod += e, e += t.shift + (r += t.change);
    }
    function Uu(n, t, e) {
        n = n._tree, t = t._tree;
    ...
    function Iu(n) {
        ...
        if ((e = n.children) && (s = e.length)) {
            ...
            if (e.forEach(Zu), r = e[0], r.x = -r.r, r.y = 0, t(r), s > 1 && (u = e[1], u.x = u.r, 
            u.y = 0, t(u), s > 2)) for (i = e[2], $u(r, u, i), t(i), Fu(r, i), r._pack_prev = i, 
            Fu(i, u), u = r._pack_next, o = 3; s > o; o++) {
                $u(r, u, i = e[o]);
                var p = 0, v = 1, d = 1;
                for (a = u._pack_next; a !== u; a = a._pack_next, v++) if (Yu(a, i)) {
                    p = 1;
                    break;
                }
                if (1 == p) for (c = r._pack_prev; c !== a._pack_prev && !Yu(c, i); c = c._pack_prev, 
                d++) ;
                p ? (d > v || v == d && u.r < r.r ? Ou(r, u = a) : Ou(r = c, u), o--) : (Fu(r, i), 
                u = i, t(i));
            }
    ...
    function Xu(n, t, e, r) {
        var u = n.children;
        if (n.x = t += r * n.x, n.y = e += r * n.y, n.r *= r, u) for (var i = -1, o = u.length; ++i < o; ) Xu(u[i], t, e, r);
    }
    function $u(n, t, e) {
    ...
    function oi(n, t, e, r) {
        function u() {
            var u = Math.min(n.length, t.length) > 2 ? ii : ei, c = r ? ru : eu;
    ...
    function si(n, t) {
        null == t && (t = 10);
        var e = ni(n), r = e[1] - e[0], u = Math.pow(10, Math.floor(Math.log(r / t) / Math.LN10)), i = t / r * u;
    ...
    function pi(n, t, e, r) {
        ...
        return o.invert = function(t) {
            ...
            var n = ni(r), o = [], a = n[0], c = n[1], s = Math.floor(u(a)), l = Math.ceil(u(c)), f = t % 1 ? 2 : t;
            if (isFinite(l - s)) {
                if (e) {
    ...
    function mi(n, t) {
        ...
        return e.domain = function(r) {
            ...
            return o = r(l + Math.round(g / 2), h), s && o.reverse(), a = Math.round(h * (1 - i)), 
            t = {
                t: "rangeRoundBands",
                a: arguments
            }, e;
    ...
    function Ei(n) {
        function t(t) {
            ...
            for (var c, s = [], l = [], f = -1, h = t.length, g = pt(e), p = pt(r); ++f < h; ) u.call(this, c = t[f], f) ? l.push([ +g.call(this, c, f), +p.call(this, c, f) ]) : l.length && (o(), 
            l = []);
            return l.length && o(), s.length ? s.join("") : null;
        }
        var e = Ze, r = Ve, u = Zt, i = Ai, o = i.key, a = .7;
        return t.x = function(n) {
            ...
            return arguments.length ? (o = "function" == typeof n ? i = n : (i = xs.get(n) || Ai).key, 
            t) : o;
    ...
    function Ui(n) {
        ...
        var t = 1, e = n.length, r = n[0], u = r[0], i = r[1], o = [ u, u, u, (r = n[1])[0] ], a = [ i, i, i, r[1] ], c = [ u, ",", i, "L", Oi(bs, o), ",", Oi(bs, a) ];
    ...
    function ji(n) {
        ...
        for (e.push(Oi(bs, i) + "," + Oi(bs, o)), --r; ++r < u; ) t = n[r], i.shift(), i.push(t[0]), 
        o.shift(), o.push(t[1]), Yi(e, i, o);
        return e.join("");
    }
    function Hi(n) {
        for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4; ) e = n[r % u], 
        o.push(e[0]), a.push(e[1]);
        for (t = [ Oi(bs, o), ",", Oi(bs, a) ], --r; ++r < i; ) e = n[r % u], o.shift(), 
        o.push(e[0]), a.shift(), a.push(e[1]), Yi(t, o, a);
        return t.join("");
    }
    function Fi(n, t) {
        var e = n.length - 1;
    ...
    function Vi(n) {
        for (var t, e, r, u, i = [], o = Zi(n), a = -1, c = n.length - 1; ++a < c; ) t = Ii(n[a], n[a + 1]), 
        aa(t) < Ca ? o[a] = o[a + 1] = 0 : (e = o[a] / t, r = o[a + 1] / t, u = e * e + r * r, 
    ...
    function Bi(n) {
        function t(t) {
            ...
            for (var h, g, p, v = [], d = [], m = [], y = -1, x = t.length, M = pt(e), _ = pt(u), b = e === r ? function() {
                ...
                return p;
            } : pt(i); ++y < x; ) o.call(this, h = t[y], y) ? (d.push([ g = +M.call(this, h, y), p = +_.call(this, h, y) ]), 
            m.push([ +b.call(this, h, y), +w.call(this, h, y) ])) : d.length && (c(), d = [], 
            m = []);
            return d.length && c(), v.length ? v.join("") : null;
        }
        var e = Ze, r = Ze, u = 0, i = Ve, o = Zt, a = Ai, c = a.key, s = a, l = "L", f = .7;
        return t.x = function(n) {
            ...
            return arguments.length ? (c = "function" == typeof n ? a = n : (a = xs.get(n) || Ai).key, 
    ...
    function uo(n, t, e, r) {
        ...
        if (!o) {
            ...
            o = i[e] = {
                ...
                function u(r) {
                    return i.active > e ? s() : (i.active = e, o.event && o.event.start.call(n, l, t), 
                    o.tween.forEach(function(e, r) {
                        (r = r.call(n, l, t)) && v.push(r);
                    }), void $o.timer(function() {
                ...
                var l = n.__data__, f = o.ease, h = o.delay, g = o.duration, p = Ga, v = [];
                return p.t = h + a, r >= h ? u(r - h) : void (p.c = u);
            }, 0, a);
        }
    }
    function io(n, t) {
    ...
    function co(n, t, e) {
        ...
        var c = n.utc = so(n);
        return c.floor = c, c.round = so(r), c.ceil = so(u), c.offset = so(i), c.range = a, 
        n;
    }
    function so(n) {
        return function(t, e) {
    ...
    function lo(n) {
        function t(t) {
            for (var r, u, i, o = [], a = -1, c = 0; ++a < e; ) 37 === n.charCodeAt(a) && (o.push(n.substring(c, a)), 
            null != (u = nl[r = n.charAt(++a)]) && (r = n.charAt(++a)), (i = tl[r]) && (r = i(t, null == u ? "e" === r ? " " : "0" : u)), 
            o.push(r), c = a + 1);
        ...
        return t.parse = function(t) {
            ...
            var u = null != e.Z && Ds !== ao, i = new (u ? ao : Ds)();
            ...
            i.setHours(e.H + Math.floor(e.Z / 100), e.M + e.Z % 100, e.S, e.L), u ? i._ : i;
        }, t.toString = function() {
            return n;
        }, t;
    }
    ...
    function jo(n) {
        var t = n.getTimezoneOffset(), e = t > 0 ? "-" : "+", r = ~~(aa(t) / 60), u = aa(t) % 60;
    ...
    function Yo(n, t, e) {
        ...
        function u(n, e) {
            var r = n[1] - n[0], u = r / e, i = $o.bisect(ol, u);
        ...
        return r.invert = function(t) {
            ...
            var i = r.domain(), o = ni(i), a = null == n ? u(o, 10) : "number" == typeof n && u(o, n);
            ...
            var e = ni(r.domain()), i = null == n ? u(e, 10) : "number" == typeof n ? u(e, n) : !n.range && [ {
                range: n
            }, t ];
    ...
    var Bo = [].slice, Wo = function(n) {
        return Bo.call(n);
    }, Jo = document, Go = Jo.documentElement, Ko = window;
    try {
    ...
    try {
        ...
        var ta = Ko.Element.prototype, ea = ta.setAttribute, ra = ta.setAttributeNS, ua = Ko.CSSStyleDeclaration.prototype, ia = ua.setProperty;
    ...
    $o.bisectLeft = oa.left, $o.bisect = $o.bisectRight = oa.right, $o.shuffle = function(n) {
        ...
        for (var n = -1, e = $o.min(arguments, t), r = new Array(e); ++n < e; ) for (var u, i = -1, o = r[n] = new Array(u); ++i < u; ) o[i] = arguments[i][n];
        return r;
    ...
    var fa = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g, ha = {}.__proto__ ? function(n, t) {
        n.__proto__ = t;
    } : function(n, t) {
    ...
    }, va = Go[a(Go, "matchesSelector")], da = function(n, t) {
        return va.call(n, t);
    };
    ...
    ma.select = function(n) {
        ...
        var t, e, r = [];
        n = d(n);
        for (var u = -1, i = this.length; ++u < i; ) for (var o = this[u], a = -1, c = o.length; ++a < c; ) (e = o[a]) && (r.push(t = Wo(n.call(e, e.__data__, a, u))), 
        t.parentNode = e);
        return p(r);
    };
    var ya = {
    ...
    $o.ns = {
        ...
        function e(n, e) {
            ...
            if (t) {
                ...
                for (r = -1; ++r < a; ) d = t.call(i = n[r], i.__data__, r), m.has(d) ? v[r] = i : m.set(d, i), 
                x.push(d);
                for (r = -1; ++r < f; ) d = t.call(e, o = e[r], r), (i = m.get(d)) ? (g[r] = i, 
                i.__data__ = o) : y.has(d) || (p[r] = k(o)), y.set(d, o), m.remove(d);
    ...
    var xa = [];
    $o.selection.enter = N, $o.selection.enter.prototype = xa, xa.append = ma.append, 
    xa.empty = ma.empty, xa.node = ma.node, xa.call = ma.call, xa.size = ma.size, xa.select = function(n) {
        ...
        for (var n, t, e = Ss || ++Ns, r = [], u = ks || {
            ...
            r.push(n = []);
            for (var a = this[i], c = -1, s = a.length; ++c < s; ) (t = a[c]) && uo(t, c, e, u), 
            n.push(t);
        }
        return to(r, e);
    ...
    var ba = "onselectstart" in Jo ? null : a(Go.style, "userSelect"), wa = 0;
    $o.mouse = function(n) {
        return P(n, h());
    };
    ...
    $o.touches = function(n, t) {
        ...
        function r(n, t, e, r) {
            return function() {
                ...
                var c, s = this, l = s.parentNode, f = u.of(s, arguments), h = $o.event.target, g = n(), p = null == g ? "drag" : "drag-" + g, v = t(l, g), d = 0, m = $o.select(Ko).on(e + "." + p, o).on(r + "." + p, a), y = D();
                i ? (c = i.apply(s, arguments), c = [ c.x - v[0], c.y - v[1] ]) : c = [ 0, 0 ], 
                f({
                    type: "dragstart"
                });
            };
        }
        var u = g(n, "drag", "dragstart", "dragend"), i = null, o = r(c, $o.mouse, "mousemove", "mouseup"), a = r(t, e, "touchmove", "touchend");
        return n.origin = function(t) {
            return arguments.length ? (i = t, n) : i;
        }, $o.rebind(n, u, "on");
    };
    var ka = Math.PI, Ea = 2 * ka, Aa = ka / 2, Ca = 1e-6, Na = Ca * Ca, La = ka / 180, Ta = 180 / ka, qa = Math.SQRT2, za = 2, Ra = 4;
    $o.interpolateZoom = function(n, t) {
        function e(n) {
            var t = n * y;
            if (m) {
                var e = O(v), o = i / (za * h) * (e * Y(qa * t + v) - F(v));
                return [ r + o * s, u + o * l, i * e / O(qa * t + v) ];
            }
            return [ r + n * s, u + n * l, i * Math.exp(qa * t) ];
        }
        var r = n[0], u = n[1], i = n[2], o = t[0], a = t[1], c = t[2], s = o - r, l = a - u, f = s * s + l * l, h = Math.sqrt(f), g = (c * c - i * i + Ra * f) / (2 * i * za * h), p = (c * c - i * i - Ra * f) / (2 * c * za * h), v = Math.log(Math.sqrt(g * g + 1) - g), d = Math.log(Math.sqrt(p * p + 1) - p), m = d - v, y = (m || Math.log(c / i)) / qa;
        ...
        function s() {
            ...
            var r = this, i = q.of(r, arguments), s = $o.event.target, l = 0, f = $o.select(Ko).on(C, n).on(N, e), h = t($o.mouse(r)), g = D();
            T.call(r), o(i);
        }
        function l() {
            function n() {
            ...
            function i() {
                for (var n, t, e, i, o = $o.touches(p), c = 0, s = o.length; s > c; ++c, i = null) if (e = o[c], 
                i = d[e.identifier]) {
                    if (t) break;
                    n = e, t = i;
                }
            ...
            var g, p = this, v = q.of(p, arguments), d = {}, m = 0, y = $o.event.changedTouches[0].identifier, M = "touchmove.zoom-" + y, _ = "touchend.zoom-" + y, b = $o.select(Ko).on(M, i).on(_, h), w = $o.select(p).on(A, null).on(L, e), k = D();
            T.call(p), e(), o(v);
        }
        function h() {
        ...
        function v() {
            var n = q.of(this, arguments), e = $o.mouse(this), i = t(e), s = Math.log(S.k) / Math.LN2;
            o(n), r(Math.pow(2, $o.event.shiftKey ? Math.ceil(s) - 1 : Math.floor(s) + 1)), 
            u(e, i), a(n), c(n);
        }
        var d, m, y, x, M, _, b, w, S = {
            ...
            y: 0,
            k: 1
        }, k = [ 960, 500 ], E = Pa, A = "mousedown.zoom", C = "mousemove.zoom", N = "mouseup.zoom", L = "touchstart.zoom", q = g(n, "zoomstart", "zoom", "zoomend");
        return n.event = function(n) {
            n.each(function() {
                ...
                Ss ? $o.select(this).transition().each("start.zoom", function() {
                    ...
                    var e = k[0], r = k[1], u = e / 2, i = r / 2, o = $o.interpolateZoom([ (u - S.x) / S.k, (i - S.y) / S.k, e / S.k ], [ (u - t.x) / t.k, (i - t.y) / t.k, e / t.k ]);
                    return function(t) {
                        var r = o(t), c = e / r[2];
                        this.__chart__ = S = {
                            x: u - r[0] * c,
    ...
    var Da, Pa = [ 0, 1 / 0 ], Ua = "onwheel" in Jo ? (Da = function() {
    ...
    var Fa = 18, Oa = .95047, Ya = 1, Ia = 1.08883, Za = K.prototype = new Z();
    ...
    Va.brighter = function(n) {
        ...
        ot(Math.min(255, ~~(t / n)), Math.min(255, ~~(e / n)), Math.min(255, ~~(r / n)))) : ot(u, u, u);
    ...
    var Qa = ".", nc = ",", tc = [ 3, 3 ], ec = "$", rc = [ "y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y" ].map(bt);
    $o.formatPrefix = function(n, t) {
        var e = 0;
        return n && (0 > n && (n *= -1), t && (n = $o.round(n, wt(n, t))), e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10), 
        e = Math.max(-24, Math.min(24, 3 * Math.floor((0 >= e ? e + 1 : e - 1) / 3)))), 
        rc[8 + e / 3];
    }, $o.round = function(n, t) {
        return t ? Math.round(n * (t = Math.pow(10, t))) / t : Math.round(n);
    }, $o.format = function(n) {
        var t = uc.exec(n), e = t[1] || " ", r = t[2] || ">", u = t[3] || "", i = t[4] || "", o = t[5], a = +t[6], c = t[7], s = t[8], l = t[9], f = 1, h = "", g = !1;
        switch (s && (s = +s.substring(1)), (o || "0" === e && "=" === r) && (o = e = "0", 
        r = "=", c && (a -= Math.floor((a - 1) / 4))), l) {
          case "n":
            c = !0, l = "g";
            break;
        ...
        "#" === i ? i = "" : "$" === i && (i = ec), "r" != l || s || (l = "g"), null != s && ("g" == l ? s = Math.max(1, Math.min(21, s)) : ("e" == l || "f" == l) && (s = Math.max(0, Math.min(20, s)))), 
        l = ic.get(l) || St;
        var p = o && c;
        return function(n) {
            if (g && n % 1) return "";
            ...
            n = l(n, s);
            var d = n.lastIndexOf("."), m = 0 > d ? n : n.substring(0, d), y = 0 > d ? "" : Qa + n.substring(d + 1);
            !o && c && (m = oc(m));
    ...
    if (tc) {
        var ac = tc.length;
        oc = function(n) {
            for (var t = n.length, e = [], r = 0, u = tc[0]; t > 0 && u > 0; ) e.push(n.substring(t -= u, t + u)), 
            u = tc[r = (r + 1) % ac];
    ...
    $o.geo.bounds = function() {
        ...
        function t(t, e) {
            var r = Tt([ t * La, e * La ]);
            if (m) {
                var u = zt(m, r), i = [ u[1], -u[0], 0 ], o = zt(i, u);
                Pt(o), o = Ut(o);
                var c = t - p, s = c > 0 ? 1 : -1, v = o[0] * Ta * s, d = aa(c) > 180;
                if (d ^ (v > s * p && s * t > v)) {
                    var y = o[1] * Ta;
                    y > g && (g = y);
        ...
        var l, f, h, g, p, v, d, m, y, x, M, _ = {
            ...
            polygonEnd: function() {
                gc.polygonEnd(), _.point = n, _.lineStart = e, _.lineEnd = r, 0 > hc ? (l = -(h = 180), 
                f = -(g = 90)) : y > Ca ? g = 90 : -Ca > y && (f = -90), M[0] = l, M[1] = h;
            }
        };
        return function(n) {
        ...
        return Na > u && (t = xc, e = Mc, r = _c, Ca > vc && (t = dc, e = mc, r = yc), u = t * t + e * e + r * r, 
        Na > u) ? [ 0/0, 0/0 ] : [ Math.atan2(e, t) * Ta, H(r / Math.sqrt(u)) * Ta ];
    };
    ...
    $o.geo.clipExtent = function() {
        ...
        var t, e, r, u, i = $o.geo.albers(), o = $o.geo.conicEqualArea().rotate([ 154, 0 ]).center([ -2, 58.5 ]).parallels([ 55, 65 ]), a = $o.geo.conicEqualArea().rotate([ 157, 0 ]).center([ -3, 19.9 ]).parallels([ 8, 18 ]), c = {
            point: function(n, e) {
                t = [ n, e ];
            }
        };
        return n.invert = function(n) {
            ...
            r = o.translate([ l - .307 * s, f + .201 * s ]).clipExtent([ [ l - .425 * s + Ca, f + .12 * s + Ca ], [ l - .214 * s - Ca, f + .234 * s - Ca ] ]).stream(c).point, 
            u = a.translate([ l - .205 * s, f + .212 * s ]).clipExtent([ [ l - .214 * s + Ca, f + .166 * s + Ca ], [ l - .115 * s - Ca, f + .234 * s - Ca ] ]).stream(c).point, 
            n;
        }, n.scale(1070);
    };
    ...
    $o.geo.path = function() {
        function n(n) {
            ...
            o && o.valid || (o = u(i)), $o.geo.stream(n, o)), i.result();
        }
        function t() {
            return o = null, n;
        }
        ...
        return n.area = function(n) {
            ...
            return dc = mc = yc = xc = Mc = _c = bc = wc = Sc = 0, $o.geo.stream(n, u(Pc)), 
            Sc ? [ bc / Sc, wc / Sc ] : _c ? [ xc / _c, Mc / _c ] : yc ? [ dc / yc, mc / yc ] : [ 0/0, 0/0 ];
        }, n.bounds = function(n) {
            return qc = zc = -(Lc = Tc = 1 / 0), $o.geo.stream(n, u(Dc)), [ [ Lc, Tc ], [ qc, zc ] ];
        }, n.projection = function(n) {
            return arguments.length ? (u = (e = n) ? n.stream || ye(n) : vt, t()) : e;
        }, n.context = function(n) {
            return arguments.length ? (i = null == (r = n) ? new le() : new de(n), "function" != typeof a && i.pointRadius(a), 
            t()) : r;
        ...
        function n() {
            var n = "function" == typeof r ? r.apply(this, arguments) : r, t = Ee(-n[0] * La, -n[1] * La, 0).invert, u = [];
        ...
        var e, r = (t[0] - n[0]) * La, u = n[1] * La, i = t[1] * La, o = Math.sin(r), a = Math.cos(r), c = Math.sin(u), s = Math.cos(u), l = Math.sin(i), f = Math.cos(i);
        ...
        return n.lines = function() {
            ...
            return arguments.length ? (y = +t, l = qe(a, o, 90), f = ze(r, e, y), h = qe(s, c, 90), 
            g = ze(i, u, y), n) : y;
    ...
    ($o.geo.stereographic = function() {
        ...
        function t(n) {
            ...
            if (v === Ze && r === Ve) t = n; else for (i = 0, t = []; m > i; ++i) t.push([ +v.call(this, u = n[i], i), +d.call(this, u, i) ]);
            for (i = 1; m > i; ++i) (t[i][1] < t[_][1] || t[i][1] == t[_][1] && t[i][0] < t[_][0]) && (_ = i);
            for (i = 0; m > i; ++i) i !== _ && (c = t[i][1] - t[_][1], a = t[i][0] - t[_][0], 
            x.push({
            ...
            for (x.sort(function(n, t) {
                ...
                if (o = x[i].index, g == x[i].angle) {
                    if (a = t[h][0] - t[_][0], c = t[h][1] - t[_][1], s = t[o][0] - t[_][0], l = t[o][1] - t[_][1], 
                    a * a + c * c >= s * s + l * l) {
                        x[i].index = -1;
                        continue;
                    }
            ...
            for (M.push(_), i = 0, o = 0; 2 > i; ++o) x[o].index > -1 && (M.push(x[o].index), 
            i++);
            for (p = M.length; y > o; ++o) if (!(x[o].index < 0)) {
    ...
    Zc.area = function() {
        ...
        for (var t, e, r, u, i, o, a = We(n), c = -1, s = this.length - We(this), l = this[s - 1]; ++c < s; ) {
            ...
            $e(o, l, u) ? ($e(i, l, u) || n.push(Be(i, o, l, u)), n.push(o)) : $e(i, l, u) && n.push(Be(i, o, l, u)), 
            i = o;
            a && n.push(n[0]), l = u;
        }
        return n;
    ...
    rr.prototype.prepare = function() {
        ...
        insert: function(n, t) {
            ...
            if (n) {
                ...
                e = n;
            } else this._ ? (n = Mr(this._), t.P = null, t.N = n, n.P = n.L = t, e = n) : (t.P = t.N = null, 
            this._ = t, e = null);
            for (t.L = t.R = null, t.U = e, t.C = !0, n = t; e && e.C; ) r = e.U, e === r.L ? (u = r.R, 
            u && u.C ? (e.C = u.C = !1, r.C = !0, n = r) : (n === e.R && (yr(this, e), n = e, 
            e = n.U), e.C = !1, r.C = !0, xr(this, r))) : (u = r.L, u && u.C ? (e.C = u.C = !1, 
            r.C = !0, n = r) : (n === e.L && (xr(this, e), n = e, e = n.U), e.C = !1, r.C = !0, 
            yr(this, r))), e = n.U;
            this._.C = !1;
        },
        remove: function(n) {
            ...
            if (e = i ? o ? Mr(o) : i : o, u ? u.L === n ? u.L = e : u.R = e : this._ = e, i && o ? (r = e.C, 
                ...
                do {
                    ...
                    if (n === u.L) {
                        if (t = u.R, t.C && (t.C = !1, u.C = !0, yr(this, u), t = u.R), t.L && t.L.C || t.R && t.R.C) {
                            t.R && t.R.C || (t.L.C = !1, t.C = !0, xr(this, t), t = u.R), t.C = u.C, u.C = t.R.C = !1, 
                            yr(this, u), n = this._;
                            break;
                        }
                    } else if (t = u.L, t.C && (t.C = !1, u.C = !0, xr(this, u), t = u.L), t.L && t.L.C || t.R && t.R.C) {
                        t.L && t.L.C || (t.R.C = !1, t.C = !0, yr(this, t), t = u.L), t.C = u.C, u.C = t.L.C = !1, 
                        xr(this, u), n = this._;
                        break;
                    }
                    t.C = !0, n = u, u = u.U;
        ...
        return n ? t(n) : (t.links = function(n) {
            ...
            return _r(e(n)).cells.forEach(function(e, r) {
                for (var u, i, o = e.site, a = e.edges.sort(ir), c = -1, s = a.length, l = a[s - 1].edge, f = l.l === o ? l.r : l.l; ++c < s; ) u = l, 
                i = f, l = a[c].edge, f = l.l === o ? l.r : l.l, r < i.i && r < f.i && wr(o, i, f) < 0 && t.push([ n[r], n[i.i], n[f.i] ]);
            }), t;
        }, t.x = function(n) {
    ...
    $o.geom.delaunay = function(n) {
        ...
        function i(n) {
            function i(n, t, e, r, u, i, o, a) {
                if (!isNaN(e) && !isNaN(r)) if (n.leaf) {
                    var c = n.x, l = n.y;
                    if (null != c) if (aa(c - e) + aa(l - r) < .01) s(n, t, e, r, u, i, o, a); else {
                        var f = n.point;
            ...
            function s(n, t, e, r, u, o, a, c) {
                ...
                n.leaf = !1, n = n.nodes[g] || (n.nodes[g] = Er()), f ? u = s : a = s, h ? o = l : c = l, 
                i(n, t, e, r, u, o, a, c);
            }
        ...
        var o, a = Ze, c = Ve;
        return (o = arguments.length) ? (a = Sr, c = kr, 3 === o && (u = e, r = t, e = t = 0), 
        i(n)) : (i.x = function(n) {
    ...
    }, $o.interpolateRgb = Cr, $o.interpolateObject = Nr, $o.interpolateNumber = Lr, 
    $o.interpolateString = Tr;
    var Qc = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
    ...
    }, $o.interpolateHcl = $r, $o.interpolateHsl = Br, $o.interpolateLab = Wr, $o.interpolateRound = Jr, 
    ...
    $o.interpolateTransform = tu, $o.layout = {}, $o.layout.bundle = function() {
        ...
        function n() {
            var n, s, f, h, g, p = {}, v = [], d = $o.range(i), m = [];
            for (e = [], r = [], n = 0, h = -1; ++h < i; ) {
        ...
        var e, r, u, i, o, a = {}, c = $o.dispatch("start", "tick", "end"), s = [ 1, 1 ], l = .9, f = us, h = is, g = -30, p = .1, v = .8, d = [], m = [];
        return a.tick = function() {
            ...
            for (e = 0; b > e; ++e) a = m[e], f = a.source, h = a.target, x = h.x - f.x, M = h.y - f.y, 
            (v = x * x + M * M) && (v = r * i[e] * ((v = Math.sqrt(v)) - u[e]) / v, x *= v, 
            M *= v, h.x -= x * (y = f.weight / (h.weight + f.weight)), h.y -= M * y, f.x += x * (y = 1 - y), 
            f.y += M * y);
            if ((y = r * p) && (x = s[0] / 2, M = s[1] / 2, e = -1, y)) for (;++e < _; ) a = d[e], 
            a.x += (x - a.x) * y, a.y += (M - a.y) * y;
            if (g) for (fu(t = $o.geom.quadtree(d), r, o), e = -1; ++e < _; ) (a = d[e]).fixed || t.visit(n(a));
            for (e = -1; ++e < _; ) a = d[e], a.fixed ? (a.x = a.px, a.y = a.py) : (a.x -= (a.px - (a.px = a.x)) * l, 
            a.y -= (a.py - (a.py = a.y)) * l);
            c.tick({
                type: "tick",
                alpha: r
            ...
            for (t = 0; l > t; ++t) r = m[t], "number" == typeof r.source && (r.source = d[r.source]), 
            "number" == typeof r.target && (r.target = d[r.target]), ++r.source.weight, ++r.target.weight;
            for (t = 0; c > t; ++t) r = d[t], isNaN(r.x) && (r.x = n("x", p)), isNaN(r.y) && (r.y = n("y", v)), 
            isNaN(r.px) && (r.px = r.x), isNaN(r.py) && (r.py = r.y);
            if (u = [], "function" == typeof f) for (t = 0; l > t; ++t) u[t] = +f.call(this, m[t], t); else for (t = 0; l > t; ++t) u[t] = f;
            if (i = [], "function" == typeof h) for (t = 0; l > t; ++t) i[t] = +h.call(this, m[t], t); else for (t = 0; l > t; ++t) i[t] = h;
            if (o = [], "function" == typeof g) for (t = 0; c > t; ++t) o[t] = +g.call(this, d[t], t); else for (t = 0; c > t; ++t) o[t] = g;
            return a.resume();
        }, a.resume = function() {
            return a.alpha(.1);
        }, a.stop = function() {
            ...
            return e || (e = $o.behavior.drag().origin(vt).on("dragstart.force", au).on("drag.force", t).on("dragend.force", cu)), 
            arguments.length ? void this.on("mouseover.force", su).on("mouseout.force", lu).call(e) : e;
        }, $o.rebind(a, c, "on");
    };
    var us = 20, is = 1;
    $o.layout.hierarchy = function() {
        function n(t, o, a) {
            ...
            if (t.depth = o, a.push(t), c && (s = c.length)) {
                for (var s, l, f = -1, h = t.children = new Array(s), g = 0, p = o + 1; ++f < s; ) l = h[f] = n(c[f], p, a), 
                l.parent = t, g += l.value;
        ...
        var r = $o.layout.hierarchy(), u = [ 1, 1 ];
        ...
        function n(i) {
            var o = i.map(function(e, r) {
                return +t.call(n, e, r);
            }), a = +("function" == typeof r ? r.apply(this, arguments) : r), c = (("function" == typeof u ? u.apply(this, arguments) : u) - a) / $o.sum(o), s = $o.range(i.length);
    ...
    $o.layout.stack = function() {
        ...
        var t = vt, e = Mu, r = _u, u = xu, i = mu, o = yu;
    ...
    var as = $o.map({
        "inside-out": function(n) {
            var t, e, r = n.length, u = n.map(bu), i = n.map(wu), o = $o.range(r).sort(function(n, t) {
                return u[n] - u[t];
            }), a = 0, c = 0, s = [], l = [];
    ...
    $o.layout.histogram = function() {
        function n(n, i) {
            ...
            if (g > 0) for (i = -1; ++i < h; ) a = s[i], a >= l[0] && a <= l[1] && (o = c[$o.bisect(f, a, 1, g) - 1], 
            o.y += p, o.push(n[i]));
            return c;
        }
        var t = !0, e = Number, r = Au, u = ku;
        ...
        function n(n, i) {
            function o(n, t) {
                ...
                if (r && (i = r.length)) {
                    for (var i, a, s, l = r[0], f = l, h = -1; ++h < i; ) s = r[h], o(s, a), f = c(s, a, f), 
                    a = s;
                    Pu(n);
            ...
            function c(n, t, r) {
                if (t) {
                    for (var u, i = n, o = n, a = t, c = n.parent.children[0], s = i._tree.mod, l = o._tree.mod, f = a._tree.mod, h = c._tree.mod; a = Lu(a), 
                    i = Nu(i), a && i; ) c = Nu(c), o = Lu(o), o._tree.ancestor = n, u = a._tree.prelim + f - i._tree.prelim - s + e(a, i), 
                    u > 0 && (Uu(ju(a, n, r), n, u), s += u, l += u), f += a._tree.mod, s += i._tree.mod, 
                    h += c._tree.mod, l += o._tree.mod;
                    a && !Lu(o) && (o._tree.thread = a, o._tree.mod += f - l), i && !Nu(c) && (c._tree.thread = i, 
                    c._tree.mod += s - h, r = n);
                }
                return r;
            }
            ...
            var f = Tu(l, zu), h = Tu(l, qu), g = Tu(l, Ru), p = f.x - e(f, h) / 2, v = h.x + e(h, f) / 2, d = g.depth || 1;
        ...
        var t = $o.layout.hierarchy().sort(null).value(null), e = Cu, r = [ 1, 1 ], u = !1;
        ...
        var t, e = $o.layout.hierarchy().sort(Hu), r = 0, u = [ 1, 1 ];
        ...
        function n(n, i) {
            ...
            Du(c, function(n) {
                var t = n.children;
                t && t.length ? (n.x = Wu(t), n.y = Bu(t)) : (n.x = o ? s += e(n, o) : 0, n.y = 0, 
                o = n);
            });
            var l = Ju(c), f = Gu(c), h = l.x - e(l, f) / 2, g = f.x + e(f, l) / 2;
        ...
        var o, a = $o.layout.hierarchy(), c = Math.round, s = [ 1, 1 ], l = null, f = Ku, h = !1, g = "squarify", p = .5 * (1 + Math.sqrt(5));
        return i.size = function(n) {
            ...
            var r;
            return f = null == (l = n) ? Ku : "function" == (r = typeof n) ? t : "number" === r ? (n = [ n, n, n, n ], 
            e) : e, i;
        }, i.round = function(n) {
    ...
    var gs = [ 2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175 ].map(it), ps = [ 2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725 ].map(it), vs = [ 3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654 ].map(it), ds = [ 3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081 ].map(it);
    $o.scale.quantile = function() {
        ...
        function n() {
            ...
            o = a, a = c), a - o), s = ka > c ? "0" : "1", l = Math.cos(o), f = Math.sin(o), h = Math.cos(a), g = Math.sin(a);
    ...
    $o.svg.line.radial = function() {
        ...
        var n = $o.svg.diagonal(), t = Ji, e = n.projection;
    ...
    var Ss, ks, Es = Math.sqrt(3), As = Math.tan(30 * La), Cs = [], Ns = 0;
    Cs.call = ma.call, Cs.empty = ma.empty, Cs.node = ma.node, Cs.size = ma.size, $o.transition = function(n) {
        ...
        for (var o = -1, a = this.length; ++o < a; ) {
            ...
            uo(e, s, u, r.__transition__[u]), t.push(e)) : t.push(null);
        }
        return to(i, u);
        ...
        var o = "transform" == n ? tu : qr, a = $o.ns.qualify(n);
        ...
        var t = this.id;
        return arguments.length < 1 ? this.node().__transition__[t].ease : ("function" != typeof n && (n = $o.ease.apply($o, arguments)), 
        C(this, function(e) {
        ...
        for (var n, t, e, r, u = this.id, i = ++Ns, o = [], a = 0, c = this.length; c > a; a++) {
            ...
            r.delay += r.duration, uo(e, s, i, r)), n.push(e);
        }
        return to(o, i);
    }, $o.svg.axis = function() {
        function n(n) {
            n.each(function() {
                var n, s = $o.select(this), l = this.__chart__ || e, f = this.__chart__ = e.copy(), h = null == c ? f.ticks ? f.ticks.apply(f, a) : f.domain() : c, g = null == t ? f.tickFormat ? f.tickFormat.apply(f, a) : vt : t, p = s.selectAll(".tick").data(h, f), v = p.enter().insert("g", ".domain").attr("class", "tick").style("opacity", Ca), d = $o.transition(p.exit()).style("opacity", Ca).remove(), m = $o.transition(p).style("opacity", 1), y = ti(f), x = s.selectAll(".domain").data([ 0 ]), M = (x.enter().append("path").attr("class", "domain"), 
                $o.transition(x));
                v.append("line"), v.append("text");
                var _ = v.select("line"), b = m.select("line"), w = p.select("text").text(g), S = v.select("text"), k = m.select("text");
                switch (r) {
                  case "bottom":
                    n = io, _.attr("y2", u), S.attr("y", Math.max(u, 0) + o), b.attr("x2", 0).attr("y2", u), 
                  ...
                  case "left":
                    n = oo, _.attr("x2", -u), S.attr("x", -(Math.max(u, 0) + o)), b.attr("x2", -u).attr("y2", 0), 
                ...
                } else v.call(n, l), m.call(n, f), d.call(n, f);
            });
        }
        var t, e = $o.scale.linear(), r = Ls, u = 6, i = 6, o = 3, a = [ 10 ], c = null;
    ...
    $o.svg.brush = function() {
        function n(i) {
            i.each(function() {
                var i = $o.select(this).style("pointer-events", "all").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)").on("mousedown.brush", u).on("touchstart.brush", u), o = i.selectAll(".background").data([ 0 ]);
                ...
                var l, f = $o.transition(i), h = $o.transition(o);
        ...
        function u() {
            ...
            function d() {
                var n = $o.mouse(_), u = !1;
                M && (n[0] += M[0], n[1] += M[1]), C || ($o.event.altKey ? (x || (x = [ (l[0] + l[1]) / 2, (h[0] + h[1]) / 2 ]), 
                L[0] = l[+(n[0] < x[0])], L[1] = h[+(n[1] < x[1])]) : x = null), E && m(n, c, 0) && (e(S), 
                u = !0), A && m(n, s, 1) && (r(S), u = !0), u && (t(S), w({
                    type: "brush",
                    mode: C ? "move" : "resize"
                }));
            }
            function m(n, t, e) {
                var r, u, a = ti(t), c = a[0], s = a[1], f = L[e], g = e ? h : l, d = g[1] - g[0];
                return C && (c -= f, s -= d + f), r = (e ? v : p) ? Math.max(c, Math.min(s, n[e])) : n[e], 
                C ? u = (r += f) + d : (x && (f = Math.max(c, Math.min(s, 2 * x[e] - r))), r > f ? (u = r, 
                r = f) : u = f), g[0] != r || g[1] != u ? (e ? o = null : i = null, g[0] = r, g[1] = u, 
                !0) : void 0;
            }
            function y() {
                d(), S.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), 
                $o.select("body").style("cursor", null), T.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), 
                N(), w({
                    type: "brushend"
                });
            }
            var x, M, _ = this, b = $o.select($o.event.target), w = a.of(_, arguments), S = $o.select(_), k = b.datum(), E = !/^(n|s)$/.test(k) && c, A = !/^(e|w)$/.test(k) && s, C = b.classed("extent"), N = D(), L = $o.mouse(_), T = $o.select(Ko).on("keydown.brush", u).on("keyup.brush", g);
            if ($o.event.changedTouches ? T.on("touchmove.brush", d).on("touchend.brush", y) : T.on("mousemove.brush", d).on("mouseup.brush", y), 
            S.interrupt().selectAll("*").interrupt(), C) L[0] = l[0] - L[0], L[1] = h[0] - L[1]; else if (k) {
                var q = +/w$/.test(k), z = +/^n/.test(k);
                M = [ l[1 - q] - L[0], h[1 - z] - L[1] ], L[0] = l[q], L[1] = h[z];
            } else $o.event.altKey && (x = L.slice());
            S.style("pointer-events", "none").selectAll(".resize").style("display", null), $o.select("body").style("cursor", b.style("cursor")), 
            w({
                type: "brushstart"
            }), d();
        }
        var i, o, a = g(n, "brushstart", "brush", "brushend"), c = null, s = null, l = [ 0, 0 ], h = [ 0, 0 ], p = !0, v = !0, d = zs[0];
        return n.event = function(n) {
            n.each(function() {
            ...
            return arguments.length ? (c && s ? (p = !!t[0], v = !!t[1]) : c ? p = !!t : s && (v = !!t), 
            n) : c && s ? [ p, v ] : c ? p : s ? v : null;
        }, n.extent = function(t) {
            var e, r, u, a, f;
            return arguments.length ? (c && (e = t[0], r = t[1], s && (e = e[0], r = r[0]), 
            i = [ e, r ], c.invert && (e = c(e), r = c(r)), e > r && (f = e, e = r, r = f), 
            (e != l[0] || r != l[1]) && (l = [ e, r ])), s && (u = t[0], a = t[1], c && (u = u[1], 
            a = a[1]), o = [ u, a ], s.invert && (u = s(u), a = s(a)), u > a && (f = u, u = a, 
            a = f), (u != h[0] || a != h[1]) && (h = [ u, a ])), n) : (c && (i ? (e = i[0], 
            r = i[1]) : (e = l[0], r = l[1], c.invert && (e = c.invert(e), r = c.invert(r)), 
            e > r && (f = e, e = r, r = f))), s && (o ? (u = o[0], a = o[1]) : (u = h[0], a = h[1], 
            s.invert && (u = s.invert(u), a = s.invert(a)), u > a && (f = u, u = a, a = f))), 
    ...
    var qs = {
        ...
        se: "nwse-resize",
        sw: "nesw-resize"
    }, zs = [ [ "n", "e", "s", "w", "nw", "ne", "se", "sw" ], [ "e", "w" ], [ "n", "s" ], [] ], Rs = $o.time = {}, Ds = Date, Ps = [ "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" ];
    ao.prototype = {
        getDate: function() {
    ...
    var Us = Date.prototype, js = "%a %b %e %X %Y", Hs = "%m/%d/%Y", Fs = "%H:%M:%S", Os = [ "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" ], Ys = [ "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" ], Is = [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ], Zs = [ "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" ];
    ...
    }), Rs.week = Rs.sunday, Rs.weeks = Rs.sunday.range, Rs.weeks.utc = Rs.sunday.utc.range, 
    Rs.weekOfYear = Rs.sundayOfYear, Rs.format = lo;
    var Vs = ho(Os), Xs = go(Os), $s = ho(Ys), Bs = go(Ys), Ws = ho(Is), Js = go(Is), Gs = ho(Zs), Ks = go(Zs), Qs = /^%/, nl = {
        "-": "",
        _: " ",
        0: "0"
    }, tl = {
    ...
    lo.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? Oo : il, 
    Oo.parse = function(n) {
        var t = new Date(n);
    ...
    window.gatrack = window.gatrack || {
        action: function(elem, category, action, label, value, callback) {
            var result = "success", intVal = parseInt(value || 0, 10);
            try {
        ...
        link: function(elem, category, action, label, value) {
            ...
            var cat = category || elem.dataset.gatrackCategory || "Link Event", act = action || elem.dataset.gatrackAction || elem.href || elem.title || elem.id, lab = label || elem.dataset.gatrackLabel, val = value || elem.dataset.gatrackValue;
            !act && elem.target && "_self" != elem.target ? act = "Outbound Link" : act || (act = "Internal Link"), 
            elem.addEventListener("click", clickEvent, !1);
        },
        click: function(elem, category, action, label, value) {
            function clickEvent() {
                gatrack.action(elem, cat, act, lab, val);
            }
            var cat = category || elem.dataset.gatrackCategory || "Click Event", act = action || elem.dataset.gatrackAction || elem.title || elem.id || "Unspecified click", lab = label || elem.dataset.gatrackLabel, val = value || elem.dataset.gatrackValue;
            elem.addEventListener("click", clickEvent, !1);
        },
        scrollAt: function(elem, scrollPoint, direction, category, action, label, value) {
            function scrollEvent() {
                var start;
                start = "y" == direct ? this.scrollY + this.clientHeight : this.scrollX + this.clientWidth, 
                start > px && gatrack.action(elem, cat, act, lab, val);
            }
            var px, point = scrollPoint || elem.dataset.gatrackScrollPoint, direct = direction || elem.dataset.gatrackScrollDirection || "y", cat = category || elem.dataset.gatrackCategory || "Scroll Event", act = action || elem.dataset.gatrackAction || elem.title || elem.id || document.getElementsByTagName("title")[0].textContent || point, lab = label || elem.dataset.gatrackLabel || direct, val = value || elem.dataset.gatrackValue;
            "%" == point.slice(-1) ? px = val = ("y" == direct ? elem.clientHeight : elem.clientWidth) * parseInt(point.slice(0, point.length - 2)) / 100 : "px" == point.slice(-2) && (px = val = parseInt(point.slice(0, point.length - 3))), 
            elem.addEventListener("scroll", scrollEvent, !1);
        },
        hover: function(elem, category, action, label, value) {
            function mouseEvent() {
                gatrack.action(elem, cat, act, lab, val);
            }
            var cat = category || elem.dataset.gatrackCategory || "Hover Event", act = action || elem.dataset.gatrackAction || elem.title || elem.id || "Unspecified hover", lab = label || elem.dataset.gatrackLabel, val = value || elem.dataset.gatrackValue;
            elem.addEventListener("mouseover", mouseEvent, !1);
        },
        touch: function(elem, category, action, label, value) {
            function touchEvent() {
                gatrack.action(elem, cat, act, lab, val);
            }
            var cat = category || elem.dataset.gatrackCategory || "Touch Event", act = action || elem.dataset.gatrackAction || elem.title || elem.id || "Unspecified touch", lab = label || elem.dataset.gatrackLabel, val = value || elem.dataset.gatrackValue;
            elem.addEventListener("touchstart", touchEvent, !1);
        },
        load: function(elem, category, action, label, value) {
            function loadEvent() {
                gatrack.action(elem, cat, act, lab, val);
            }
            var cat = category || elem.dataset.gatrackCategory || "Load Event", act = action || elem.dataset.gatrackAction || elem.title || elem.id || "Unspecified load", lab = label || elem.dataset.gatrackLabel, val = value || elem.dataset.gatrackValue;
            elem.addEventListener("load", loadEvent, !1);
        },
        init: function() {
            var i, linkable = document.getElementsByClassName("ga-link-trackable"), loadable = document.getElementsByClassName("ga-load-trackable"), scrollable = document.getElementsByClassName("ga-scroll-trackable"), hoverable = document.getElementsByClassName("ga-hover-trackable"), touchable = document.getElementsByClassName("ga-touch-trackable"), clickable = document.getElementsByClassName("ga-click-trackable");
            for (i = linkable.length - 1; i >= 0; i--) gatrack.link(linkable[i]);
            for (i = loadable.length - 1; i >= 0; i--) gatrack.load(loadable[i]);
            for (i = scrollable.length - 1; i >= 0; i--) gatrack.scrollAt(scrollable[i]);
            for (i = hoverable.length - 1; i >= 0; i--) gatrack.hover(hoverable[i]);
            for (i = touchable.length - 1; i >= 0; i--) gatrack.touch(touchable[i]);
            for (i = clickable.length - 1; i >= 0; i--) gatrack.click(clickable[i]);
        }
    }, window.gatrack.init();
    ...
    var undefined, arrayPool = [], objectPool = [], idCounter = 0, indicatorObject = {}, maxPoolSize = 40, reEmptyStringLeading = /\b__p \+= '';/g, reEmptyStringMiddle = /\b(__p \+=) '' \+/g, reEmptyStringTrailing = /(__e\(.*?\)|\b__t\)) \+\n'';/g, reEsTemplate = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, reFuncName = /^\s*function[ \n\r\t]+\w/, reInterpolate = /<%=([\s\S]+?)%>/g, reNoMatch = /($^)/, reThis = /\bthis\b/, reUnescapedString = /['\n\r\t\u2028\u2029\\]/g, shadowedProps = [ "constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf" ], templateCounter = 0, argsClass = "[object Arguments]", arrayClass = "[object Array]", boolClass = "[object Boolean]", dateClass = "[object Date]", errorClass = "[object Error]", funcClass = "[object Function]", numberClass = "[object Number]", objectClass = "[object Object]", regexpClass = "[object RegExp]", stringClass = "[object String]", descriptor = {
        configurable: !1,
        enumerable: !1,
        value: null,
        writable: !1
    ...
    var arrayRef = [], errorProto = Error.prototype, objectProto = Object.prototype, stringProto = String.prototype, toString = objectProto.toString, reNative = RegExp("^" + String(toString).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"), fnToString = Function.prototype.toString, hasOwnProperty = objectProto.hasOwnProperty, push = arrayRef.push, propertyIsEnumerable = objectProto.propertyIsEnumerable, unshift = arrayRef.unshift, defineProperty = function() {
        try {
            var o = {}, func = isNative(func = Object.defineProperty) && func, result = func(o, o, o) && func;
        } catch (e) {}
        return result;
    }(), nativeCreate = isNative(nativeCreate = Object.create) && nativeCreate, nativeIsArray = isNative(nativeIsArray = Array.isArray) && nativeIsArray, nativeKeys = isNative(nativeKeys = Object.keys) && nativeKeys, nonEnumProps = {};
    ...
    !function() {
        ...
        support.enumPrototypes = propertyIsEnumerable.call(ctor, "prototype"), support.funcDecomp = !isNative(root.WinRTError) && reThis.test(function() {
            return this;
        }), support.funcNames = "string" == typeof Function.name, support.nonEnumArgs = 0 != key, 
        support.nonEnumShadows = !/valueOf/.test(props), support.spliceObjects = (arrayRef.splice.call(object, 0, 1), 
        !object[0]), support.unindexedChars = "x"[0] + Object("x")[0] != "xx";
    ...
    var isArray = nativeIsArray || function(value) {
        ...
        '"': "&quot;",
        "'": "&#39;"
    }, reUnescapedHtml = RegExp("[" + keys(htmlEscapes).join("") + "]", "g"), baseEach = createIterator(eachIteratorOptions), defaults = createIterator(defaultsIteratorOptions), forIn = createIterator(eachIteratorOptions, forOwnIteratorOptions, {
        useHas: !1
    ...
    lodash.bind = bind, lodash.chain = chain, lodash.createCallback = createCallback, 
    lodash.defaults = defaults, lodash.delay = delay, lodash.forEach = forEach, lodash.forEachRight = forEachRight, 
    lodash.forIn = forIn, lodash.forOwn = forOwn, lodash.functions = functions, lodash.indexBy = indexBy, 
    lodash.keys = keys, lodash.map = map, lodash.property = property, lodash.sortBy = sortBy, 
    lodash.values = values, lodash.collect = map, lodash.each = forEach, lodash.eachRight = forEachRight, 
    lodash.methods = functions, mixin(lodash), lodash.escape = escape, lodash.find = find, 
    lodash.findLast = findLast, lodash.identity = identity, lodash.isArguments = isArguments, 
    lodash.isArray = isArray, lodash.isFunction = isFunction, lodash.isObject = isObject, 
    lodash.isString = isString, lodash.mixin = mixin, lodash.noop = noop, lodash.template = template, 
    lodash.uniqueId = uniqueId, lodash.detect = find, lodash.findWhere = find, mixin(function() {
        var source = {};
        return forOwn(lodash, function(func, methodName) {
            lodash.prototype[methodName] || (source[methodName] = func);
        }), source;
    }(), !1), forOwn(lodash, function(func, methodName) {
    ...
    }), "function" == typeof define && "object" == typeof define.amd && define.amd ? (root._ = lodash, 
    define(function() {
        return lodash;
    })) : freeExports && freeModule ? moduleExports ? (freeModule.exports = lodash)._ = lodash : freeExports._ = lodash : root._ = lodash;
}.call(this), function(window, document, _) {
    function asyncRequest(url, id, fn) {
        window.loCallbacks = window.loCallbacks || {
            cntr: 0
        };
    ...
    function doJSONP(url, callbackFuncName, cbName) {
        var fullUrl = url + "&" + (cbName || "callback") + "=" + callbackFuncName, script = document.createElement("script");
        script.src = fullUrl, document.body.appendChild(script);
    }
    function request(url, cb, method, post, contenttype) {
        ...
        try {
            ...
            try {
                ...
                return console && console.log("_.request: XMLHttpRequest not supported"), null;
            }
        }
        requestTimeout = setTimeout(function() {
            xhr.abort(), cb(new Error("_.request: aborted by timeout"), "", xhr);
        }, 1e4), xhr.onreadystatechange = function() {
            4 == xhr.readyState && (clearTimeout(requestTimeout), cb(200 != xhr.status ? new Error("_.request: server respnse status is " + xhr.status) : !1, xhr.responseText, xhr));
        }, xhr.open(method ? method.toUpperCase() : "GET", url, !0), post ? (xhr.setRequestHeader("Content-type", contenttype ? contenttype : "application/x-www-form-urlencoded"), 
        xhr.send(post)) : xhr.send();
    }
    _.mixin({
...
}(this, this.document, _), function(window, document) {
    function makeScroller(scrollToPath) {
        return function() {
            var path = scrollToPath;
            scrollElemTo(window, document.getElementById(path).offsetTop, 1e3), window.history.pushState({
                path: path
            }, "bbbench " + path, "/#" + path);
        };
    }
    for (var scrollers = document.getElementsByClassName("scroller"), length = scrollers.length, i = 0; length > i; i++) scrollers[i].onclick = makeScroller(scrollers[i].dataset.scrollElemTo);
}(this, this.document), window.scrollElemTo = function(element, to, duration) {
    var start = element.scrollTop, change = to - start, currentTime = 0, increment = 20, easeInOutQuad = function(t, b, c, d) {
        return t /= d / 2, 1 > t ? c / 2 * t * t + b : (t--, -c / 2 * (t * (t - 2) - 1) + b);
    }, animateScroll = function() {
        currentTime += increment;
        var val = easeInOutQuad(currentTime, start, change, duration);
        element.scrollTop = val, duration > currentTime && setTimeout(animateScroll, increment);
    };
    animateScroll();
}, function(window, document) {
    function makeRevealer() {
        for (var elems = document.getElementsByClassName(this.dataset.activate), deacts = document.getElementsByClassName(this.dataset.deactivate), i = 0; i < elems.length; i++) classie.toggle(elems[i], "active");
        for (i = 0; i < deacts.length; i++) classie.toggle(deacts[i], "active");
    }
    for (var revealers = document.getElementsByClassName("activator"), length = revealers.length, i = 0; length > i; i++) revealers[i].addEventListener("click", makeRevealer, !1);
}(this, this.document), function(window, document) {
    function toggleActives() {
        for (var j = 0; length > j; j++) classie.toggle(btns[j].parentNode, "active");
    }
    for (var btns = document.getElementsByClassName("toggle-btn"), length = btns.length, i = 0; length > i; i++) btns[i].addEventListener("click", toggleActives, !1);
}(this, this.document), window.io && (window.socket = io.connect(window.location.hostname)), 
function(window, document) {
    function togglePassword(evt) {
        evt.preventDefault();
        var type = this.dataset.toggleTo, fields = document.getElementById("settings-fields");
        if ("change" == type) {
            var div = document.createElement("div"), label = document.createElement("label"), input = document.createElement("input");
            input.type = "password", input.name = "password_conf", input.placeholder = "New password", 
            input.className = "password-field", label.for = "password", label.textContent = "New password", 
            div.className = "pure-control-group", div.appendChild(label), div.appendChild(input), 
            fields.insertBefore(div, fields.children[fields.children.length - 1]), div = document.createElement("div"), 
            label = document.createElement("label"), input = document.createElement("input"), 
            input.type = "password", input.name = "password_conf", input.placeholder = "Confirm password", 
            input.className = "password-field", label.for = "password_conf", label.textContent = "Confirm password", 
            div.className = "pure-control-group", div.appendChild(label), div.appendChild(input), 
            fields.insertBefore(div, fields.children[fields.children.length - 1]), this.textContent = "Keep password", 
            this.dataset.toggleTo = "keep";
        } else fields.removeChild(fields.children[fields.children.length - 2]), fields.removeChild(fields.children[fields.children.length - 2]), 
        this.textContent = "Change password", this.dataset.toggleTo = "change";
    }
    function toggleLogin(evt) {
        evt.preventDefault();
        var type = this.dataset.toggleTo, fields = document.getElementById("login-fields");
        if ("register" == type) {
            var div = document.createElement("div"), label = document.createElement("label"), input = document.createElement("input");
            input.type = "password", input.name = "password_conf", input.placeholder = "Confirm password", 
            input.className = "password-field", label.for = "password_conf", label.textContent = "Confirm password", 
            div.className = "pure-control-group", div.appendChild(label), div.appendChild(input), 
            fields.insertBefore(div, fields.children[fields.children.length - 1]), fields.parentNode.children[0].childNodes[0].textContent = "Register", 
            this.textContent = "Sign In", this.dataset.toggleTo = "signin", fields.parentNode.action = "/register";
        } else fields.removeChild(fields.children[fields.children.length - 2]), fields.parentNode.children[0].childNodes[0].textContent = "Sign In", 
        this.textContent = "Register", this.dataset.toggleTo = "register", fields.parentNode.action = "/sign-in";
    }
    var switchLogin = document.getElementById("switch-login"), switchPassword = document.getElementById("switch-password");
    switchLogin && switchLogin.addEventListener("click", toggleLogin, !1), switchPassword && switchPassword.addEventListener("click", togglePassword, !1);
}(this, this.document), function(window, document) {
    function checkAuth() {
    ...
    function handleAuthResult(authResult) {
        var authorizeButtons = document.getElementsByClassName("authorize-button"), i = 0;
        if (authResult && !authResult.error) {
            for (i = authorizeButtons.length - 1; i >= 0; i--) authorizeButtons[i].style.visibility = "hidden";
            document.getElementById("land").style.display = "none", document.getElementById("sea").style.display = "inherit", 
            progress(0), window.gapi.client.load("analytics", "v3", makeApiCall);
        } else for (i = authorizeButtons.length - 1; i >= 0; i--) authorizeButtons[i].style.visibility = "", 
        authorizeButtons[i].addEventListener("click", handleAuthClick, !1);
    }
    ...
    function queryWebProperties(accountId) {
        console.log(accountId), progress(33), window.gapi.client.analytics.management.webproperties.list({
            accountId: accountId
        }).execute(handleWebproperties);
    }
    function queryProfiles(accountId, webPropertyId) {
        console.log(accountId, webPropertyId), progress(66), window.gapi.client.analytics.management.profiles.list({
            accountId: accountId,
    ...
    function readyChoiceLinks(funktion) {
        function handleChoice(evt) {
            evt.target.dataset.accountId ? funktion(evt.target.dataset.accountId, evt.target.dataset.itemId) : evt.target.dataset.profileName ? funktion(evt.target.dataset.itemId, evt.target.dataset.profileName) : funktion(evt.target.dataset.itemId), 
            window.scrollElemTo(document.body, 0, 500);
        }
        var items = document.getElementsByClassName("appending-list"), i = 0;
        for (i = items.length - 1; i >= 0; i--) items[i].addEventListener("click", handleChoice, !1);
    }
    function handleAccounts(results) {
        if (results.code) generalAlert({
            error: "There was an error querying accounts: " + results.message
            ...
            for (i = 0; i < results.items.length; i++) appendingList.push('<li><a class="link-button" data-item-id="' + results.items[i].id + '">' + results.items[i].name + "</a></li>");
            appendingList.push(dndCtaTemplate()), optionsDiv.innerHTML = appendingList.join(""), 
            readyChoiceLinks(queryWebProperties);
        } else console.log("No accounts found for this user."), optionsDiv.innerHTML += "<p>No accounts found for this user.</p>";
    }
    function handleWebproperties(results) {
        if (results.code) console.log(results), generalAlert({
            error: "There was an error querying webproperties: " + results.message
        }); else if (results && results.items && results.items.length) {
            var appendingList = [ '<h2 class="upper prompt-header">Choose a web property</h2><ul class="appending-list">' ];
            for (i = 0; i < results.items.length; i++) appendingList.push('<li><a class="link-button" data-account-id="' + results.items[i].accountId + '" data-item-id="' + results.items[i].id + '">' + results.items[i].name + "</a></li>");
            appendingList.push(dndCtaTemplate()), optionsDiv.innerHTML = appendingList.join(""), 
            readyChoiceLinks(queryProfiles);
        } else console.log("No webproperties found for this account."), optionsDiv.innerHTML += "<p>No webproperties found for this account.</p>";
    }
    function handleProfiles(results) {
        if (results.code) console.log(results), generalAlert({
            error: "There was an error querying views (profiles): " + results.message
        }); else if (results && results.items && results.items.length) {
            var appendingList = [ '<h2 class="upper prompt-header">Finally, choose a profile</h2><ul class="appending-list">' ];
            for (i = 0; i < results.items.length; i++) appendingList.push('<li><a class="link-button" data-item-id="' + results.items[i].id + '" data-profile-name="' + results.items[i].name + '">' + results.items[i].name + "</a></li>");
            appendingList.push(dndCtaTemplate()), optionsDiv.innerHTML = appendingList.join(""), 
            readyChoiceLinks(addProfile);
        } else console.log("No views (profiles) found for this account."), optionsDiv.innerHTML += "<p>No views (profiles) found for this account.</p>";
    }
    function handleLiveReportingResults(results) {
        results.error ? (console.log(results), generalAlert({
            error: "There was an error querying Google Analytics: " + results.message
        }), clearInterval(starkLines.runningInterval)) : pushResults(results);
    }
    function handleDownloadCreation() {
        window.URL = window.URL || window.webkitURL;
        var content = JSON.stringify(window.starkLines.profileList), blob = new Blob([ content ], {
            type: "application/json"
        }), link = document.getElementById("download-button"), d = new Date();
        link.style.visibility = "visible", link.href = window.URL.createObjectURL(blob), 
        link.download = [ "stark_lines_config_", d.getFullYear().toString(), "_", (d.getMonth() + 1).toString(), "_", d.getDate().toString(), ".json" ].join("");
    }
    function addProfile(profile, profileName) {
        function wantToRemove() {
            var resp = confirm("Remove this profile?");
            if (resp === !0) {
                var pos = [].indexOf.call(this.parentNode.parentNode.children, this.parentNode);
                starkLines.profileList.splice(pos, 1), starkLines.data[pos] = window.d3.range(60).map(window.initial), 
                starkLines.allData[pos] = window.d3.range(60).map(window.initial), this.parentNode.parentNode.removeChild(this.parentNode);
            }
        }
        progress(100), document.getElementById("social-links").style.display = "inherit";
        var rb = document.getElementById("reload-button"), counters = document.getElementById("counters"), closers = (counters.children.length, 
        document.getElementsByClassName("close-profile"));
        rb.innerHTML = "Add Profile", rb.className = "", rb.addEventListener("click", function() {
            makeApiCall();
        }, !1), optionsDiv.innerHTML = null, counters.innerHTML += profileTemplate({
            profile: profile.toString(),
            profileName: profileName,
            color: color(starkLines.profileList.length - 1)
        });
        for (var i = closers.length - 1; i >= 0; i--) closers[i].addEventListener("click", wantToRemove, !1);
        starkLines.profileList.indexOf ? -1 == starkLines.profileList.indexOf(profile) && starkLines.profileList.push({
            id: profile,
            name: profileName
        }) : starkLines.profileList.push({
            id: profile,
            name: profileName
        }), starkLines.running === !1 && (document.getElementById("graph1").style.display = "block", 
        window.innerHeight > 700 && (document.getElementById("graph1").style.height = (window.innerHeight / 2).toString() + "px"), 
        runnable()), starkLines.profileList.length == starkLines.data.length && (rb.style.display = "none"), 
        setTimeout(handleDownloadCreation, 1);
    }
    function pushResults(results) {
        var position = 0;
        for (i = 0; i < starkLines.data.length; i++) {
            if (starkLines.data[i][59].profileId == results.profileInfo.profileId) return position = i, 
            void pusher(position, results);
            if ("" === starkLines.data[i][59].profileId) return position = i, void pusher(position, results);
        }
    }
    function pusher(position, results) {
        results.rows && results.rows.sort(function(a, b) {
            return parseInt(b[1], 10) - parseInt(a[1], 10);
        });
        var count = results.rows ? window.d3.sum(results.rows, function(d) {
            return parseInt(d[1], 10);
        }) : 0, el = document.getElementById(results.profileInfo.profileId.toString() + "-counter"), dataObj = {
            time: new Date().getTime(),
            value: count,
            profileName: results.profileInfo.profileName,
            profileId: results.profileInfo.profileId
        };
        el.innerHTML = count, el = document.getElementById(results.profileInfo.profileId.toString() + "-top"), 
        el.innerHTML = results.rows ? results.rows[0][0].substring(0, 40) + "... " + results.rows[0][1] : "", 
        el = document.getElementById(results.profileInfo.profileId.toString() + "-link"), 
        el.href || (el.href = "https://www.google.com/analytics/web/?hl=en#realtime/rt-overview/a" + results.profileInfo.accountId.toString() + "w" + results.profileInfo.internalWebPropertyId.toString() + "p" + results.profileInfo.profileId.toString()), 
        starkLines.data[position].shift(), starkLines.data[position].push(dataObj), starkLines.allData[position].push(dataObj);
    }
    function initial() {
        return {
            time: new Date().getTime(),
    ...
    function color(int) {
        var co = window.d3.scale.linear().domain([ 0, starkLines.profileList.length - 1 ]).range([ "#24B1E0", "#F80F40" ]);
        return co(int);
    }
    function drawMe() {
        document.getElementById("graph1").innerHTML = null;
        {
            var divvy = window.d3.select("#divvy"), m = (starkLines.data.length, starkLines.data[0].length), stack = window.d3.layout.stack(), layers = stack(starkLines.data.map(function(dd) {
            ...
            })), yStackMax = (window.d3.max(layers, function(layer) {
                return window.d3.max(layer, function(d) {
                    return d.y;
                });
            }), function() {
                return window.d3.max(layers, function(layer) {
                    return window.d3.max(layer, function(d) {
                        return d.y0 + d.y;
                    });
                });
                ...
                bottom: 0,
                left: 0
            }, width = document.getElementById("graph1").offsetWidth - margin.left - margin.right, height = document.getElementById("graph1").offsetHeight - margin.top - margin.bottom, x = window.d3.scale.ordinal().domain(window.d3.range(m)).rangeRoundBands([ 0, width ], .05), y = window.d3.scale.linear().domain([ 0, yStackMax() ]).range([ height, 0 ]), svg = (window.d3.svg.axis().scale(x).tickSize(0).tickPadding(6).orient("bottom"), 
            window.d3.select("#graph1").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")")), layer = svg.selectAll(".layer").data(layers).enter().append("g").attr("class", "layer").style("fill", function(d, i) {
                return color(i);
            });
            ...
            }).attr("transform", "translate(" + x(1) + ")").transition().duration(starkLines.delay - 50).attr("transform", "translate(" + x(0) + ")");
        }
        layer.selectAll("rect").on("mouseover", function(d) {
            d3.select(this).style("stroke", color).style("opacity", .75), divvy.transition().duration(200).style("opacity", .8), 
            divvy.html(d.y.toString() + " visitors<br>" + d.profileName).style("left", d3.event.pageX + "px").style("top", d3.event.pageY - 28 + "px");
        }).on("mouseout", function() {
            divvy.transition().duration(200).style("opacity", 0), divvy.html(""), d3.select(this).style("opacity", 1);
        });
        for (var i = 0; i < starkLines.profileList.length; i++) document.getElementById(starkLines.profileList[i].id + "-counter").parentNode.style.backgroundColor = color(i);
    }
    function runnable() {
        starkLines.running = !0;
        var i;
        for (i = 0; i < starkLines.profileList.length; i++) setTimeout(queryLiveReportingApi, 110, starkLines.profileList[i].id);
        drawMe(), starkLines.runningInterval = setInterval(function() {
            for (i = 0; i < starkLines.profileList.length; i++) setTimeout(queryLiveReportingApi, 110, starkLines.profileList[i].id);
            drawMe(), window.d3.timer.flush();
        }, starkLines.delay);
    }
    function generalAlert(data) {
        var messageElem = document.getElementById("messages"), wrapper = messageElem.children[0];
        data.error ? wrapper.innerHTML = errorTemplate({
            error: data.error
        }) : data.message && (wrapper.innerHTML = messageTemplate({
    ...
    var clientId = "248017327299", apiKey = "AIzaSyA1TucEclEzMXJpeg9wL6ivbwDDbDPXZeU", scopes = "https://www.googleapis.com/auth/analytics.readonly", dndCtaTemplate = _.template('</ul><p class="appending-p">Or, you can drag and drop a Stark Lines configuration file anywhere on this page.<br><a href="http://www.bckmn.com/blog/even-starker-lines" target="_blank">You can read more here.</a></p>'), profileTemplate = _.template([ '<div class="pure-u-1-5 profile-wrap">', '<span class="icon-cross2 close-profile" title="Remove Profile"></span>', '<a target="_blank" id="<%= profile %>-link">', '<div class="borders" style="border-color:<%= color %>;">', '<h2 class="live-name"><%= profileName %></h2>', "</div>", '<div class="live-counter" style="background-color:<%= color %>;" title="Active visitors">', '<span id="<%= profile %>-counter" class="odometer odometer-theme-default">0</span>', "</div>", '<small class="live-top" id="<%= profile %>-top"></small>', "</a>", "</div>" ].join("")), messageTemplate = _.template([ '<p class="pull-center message">', '<a onclick="dismissAlert(this.parentNode.parentNode);" class="dismiss-alert"><span class="icon-cross"></span></a>', "<%= message %>", "</p>" ].join("")), errorTemplate = _.template([ '<p class="pull-center error">', '<a onclick="dismissAlert(this.parentNode.parentNode);" class="dismiss-alert"><span class="icon-cross"></span></a>', "<%= error %>", "</p>" ].join("")), optionsDiv = document.getElementById("options");
    window.starkLines = {
        data: window.d3.range(30).map(function() {
            return window.d3.range(60).map(initial);
        }),
        allData: window.d3.range(30).map(function() {
            return [];
        }),
        profileList: [],
        running: !1,
        ...
        window.gapi.client.setApiKey(apiKey), window.setTimeout(checkAuth, 100);
    }, function() {
        function handleDragOver(evt) {
            evt.stopPropagation(), evt.preventDefault(), evt.dataTransfer.dropEffect = "copy";
        }
        function loadFileProfiles(profileArray) {
            var i = 0, length = profileArray.length;
            for (window.starkLines.profileList = [], window.starkLines.data = window.d3.range(30).map(function() {
                return window.d3.range(60).map(window.initial);
            }), window.starkLines.allData = window.d3.range(30).map(function() {
                return [];
            }), document.getElementById("counters").innerHTML = null; length > i; i++) addProfile(profileArray[i].id, profileArray[i].name);
        }
        function handleJSONDrop(evt) {
            ...
            if (evt.stopPropagation(), evt.preventDefault(), window.File && window.FileReader && window.FileList && window.Blob) for (var f, files = evt.dataTransfer.files, i = 0; i < files.length; i++) if (f = files[i], 
            f.type.match("application/json") || f.type.match("")) {
                var reader = new FileReader();
                reader.onload = makeReaderLoadFxn(), reader.readAsText(f);
            } else generalAlert({
                error: "You're gonna need to upload a valid JSON file to configure this baby!\nCurrently, you are uploading a file of type \"" + f.type.toString() + '."'
            }); else generalAlert({
                error: "Javascript File APIs are not fully supported in this here browser.\n Ya'll have to manually add profiles!"
            });
        }
        var dropZone = document.getElementsByTagName("body")[0];
        dropZone.addEventListener("dragover", handleDragOver, !1), dropZone.addEventListener("drop", handleJSONDrop, !1);
    }();
}(this, this.document);