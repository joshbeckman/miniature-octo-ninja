    ...
    function addProfile(profile, profileName) {
        function wantToRemove() {
            ...
            if (resp === !0) {
                ...
                starkLines.profileList.splice(pos, 1), starkLines.data[pos] = window.d3.range(60).map(initial), 
                starkLines.allData[pos] = window.d3.range(60).map(initial), this.parentNode.parentNode.removeChild(this.parentNode);
            }
        }
